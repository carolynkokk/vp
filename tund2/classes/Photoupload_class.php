	...
	class Photoupload{
		...
		public function addWatermark($wmfile){
			if(isset($this->mynewtempimage)){
				...
				$wmx = imagesx($this->mynewtempimage) - $wmx - 10;
				$wmy = imagesy($this->mynewtempimage) - $wmy - 10;
				
				//kopeerimime vesimärgi vähendatud pildile
				imagecopy($this->mynewtempimage, $watermark, $wmx, $wm, 0, 0, $wmw, $wmh);
