 ...
 require("fnc_user.php");
  ...
  if(isset($_POST["profilesubmit"])) {
	...
	if(!empty($_POST["emailinput"])){
		...
		$emailerror .= "E-post puudub! Sisesta e-posti aadress!";
	}	
	if(empty($_POST["passwordinput"]))  {
		$passworderror .= "Salasõna puudub! Sisesta salasõna!";
	} else {
	...
	if(empty($_POST["passwordsecondaryinput"])) {
		$passwordsecondaryerror .= "Salasõna kordus puudub! Sisesta salasõna kordus!";
	} else {
		if($_POST["passwordsecondaryinput"] != $_POST["passwordinput"]){
			  $passwordsecondaryerror = "Sisestatud salasõnad ei olnud ühesugused! Kontrolli sisestatud salasõnu!";
		  }
	  }
