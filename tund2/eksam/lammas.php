...
if(isset($_POST["commentsubmit"]) and !empty($_POST["kommentaar"])){
    ...
    $stmt = $conn->prepare("INSERT INTO sheepcomment (kommentaar, autor) VALUES (?, ?)");
    //echo $conn->error;
...
$conn = new mysqli($serverhost, $serverusername, $serverpassword, $database);
$stmt = $conn->prepare("SELECT autor, kommentaar FROM sheepcomment");
//echo $conn->error;
